    ...
    <b-navbar class="navbar" type="dark" variant="primary">
      <b-navbar-nav>
        ...
        <nav class="navbar bg-danger-fluid">
          <div class="row">
            <div class="col-md-4">
              <button type="button" class="btn1 btn-danger">INICIO</button>
            </div>
            <div class="col-md-4 offset-md-4">
              <button type="button" class="btn2 btn-success">SALIR</button>
            </div>
          </div>
        </nav>
      </b-navbar-nav>
                ...
                <div class="combo">
                  ...
                  <div class="preguntas1">
                    ...
                    <div class="preguntas">
                      ...
                      <br>
                      <br>
                      <b-button class="button1  " sm="4" @click="guardar()" variant="outline-primary">
                        VER
                        EMPLEO </b-button>
                      <br>
                      <br>
          ...
          <div class="container">
            <div class="row">
                ...
                <b-card>
                  ...
                  <b-card-footer footer-bg-variant="success" footer-text-variant="white">Publicar</b-card-footer>
