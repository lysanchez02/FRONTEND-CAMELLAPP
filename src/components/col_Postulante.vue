  ...
  <div class="container">
    <div>
      <b-card no-body style="max-width: 20rem;"
        ...
        <b-card-body>
          <b-card-title>Postulante</b-card-title>
          <b-card-sub-title class="mb-2">Popayan - Cauca</b-card-sub-title>
          <a href="">Ver mas...</a>
        </b-card-body>
        <b-list-group flush>
          <b-list-group-item button @click="show = ''">Gestionar perfil </b-list-group-item>
          <b-list-group-item button @click="show = ''">Ofertas de empleo</b-list-group-item>
          <b-list-group-item button @click="show = ''">Mis Postulaciones</b-list-group-item>
