    ...
    <div class="container">
      <div class="row">
            ...
            <b-input-group>
              ...
              <template #prepend>
                <b-dropdown text="Mas Opciones">
                  <b-dropdown-item button @click="show = 'OfertasEmpleador'"
                    >Todas las ofertas</b-dropdown-item
                  >
        ...
        <div class="col-3">
          <b-button
            variant="success"
            @click="show = 'PublicarView'"
            v-b-popover.hover.top="'Publica Un Nuevo Empleo'"
          >
            <b-icon icon="plus"> </b-icon>Nueva Oferta
          </b-button>
        </div>
      </div>
      ...
      <br />
      <div>
        <div> TODOS LOS EMPLEOS </div>
        <div v-if="show === 'EditarOferta'">
          <EditarOferta />
        </div>
        <div v-if="show === 'PublicarView'">
          <PublicarView />
        </div>
        <div v-if="show === 'OfertasEmpleador'">
          <div class="row d-flex">
            ...
            <div v-show="eliminar" class="col-lg-6">
              ...
              >
                <b-card-text
                  >Se requiere ayudante de construccion por 6 meses</b-card-text
                >
                ...
                <b-button
                  ...
                  variant="danger"
                  class="m-1"
                  ><b-icon icon="trash"></b-icon>Eliminar oferta</b-button
                >
                <b-button
                  button
                  @click="show = 'EditarOferta'"
                  variant="primary"
                  class="m-1"
                  ><b-icon icon="pencil"></b-icon> Editar oferta</b-button
                >
              </b-card>
            </div>
            <!--end card-->
            ...
            <div v-show="eliminar" class="col-6">
              ...
              >
                <b-card-text
                  >Empresa requiere personal para el area de pintura por tiempo
                  indefinido</b-card-text
                >
                <b-card-text>Pago: $1'000.000</b-card-text>
                <b-button button @click="!eliminar" variant="danger" class="m-1"
                  ><b-icon icon="trash"></b-icon>Eliminar oferta</b-button
                >
            ...
            <div v-show="eliminar" class="col-6">
              ...
              >
                <b-card-text
                  >Se requiere electricista para obra de construccion por 8
                  meses</b-card-text
                >
            ...
            <div v-show="eliminar" class="col-6">
              ...
              >
                <b-card-text
                  >Busco soldador para instalar puertas metalicas</b-card-text
                >
                <b-card-text>Pago: $80.000 x dia</b-card-text>
                <b-button href="#" variant="danger" class="m-1"
                  ><b-icon icon="trash"></b-icon>Eliminar oferta</b-button
                >
                <b-button href="#" variant="primary" class="m-1"
                  ><b-icon icon="pencil"></b-icon> Editar oferta</b-button
                >
              </b-card>
            </div>
            ...
            <div v-show="eliminar" class="col-6">
              ...
              >
                <b-card-text
                  >solicito a una persona para instalar dos baños</b-card-text
                >
            ...
            <div v-show="eliminar" class="col-6">
              ...
              >
                <b-card-text
                  >Se requiere soldador por tiempo indefinido</b-card-text
                >
                <b-card-text>Pago: $1'000.000</b-card-text>
                <b-button
                  button
            ...
            <div v-show="eliminar" class="col-6">
              ...
              >
                <b-card-text
                  >Necesito un jardinero para cortar el pasto en un lote de
                  100m2</b-card-text
                >
                <b-card-text>Pago: $a convenir</b-card-text>
                <b-button
            ...
            <div v-show="eliminar" class="col-6">
              ...
              >
                <b-card-text
                  >Se requieren 5 ayudantes de construccion por 4
                  meses</b-card-text
                >
                <b-card-text>Pago: $1'000.000</b-card-text>
                <b-button
