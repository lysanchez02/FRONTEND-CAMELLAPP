        ...
        <b-form>
          ...
          <template>
            <div>
              ...
              <b-form-select v-model="form.disponibilidad" :options="ListaDisponibilidad"
                style="width: 53.5rem; height: 2.5rem; border-radius: 0.35rem;"
                :selected="[[user.disponibilidad]]"></b-form-select>
            </div>
          </template><br>
          <!--Disponibilidad-->
          <!--Nacionalidad-->
