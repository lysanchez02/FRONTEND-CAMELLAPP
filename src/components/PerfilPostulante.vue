    ...
    <div class="row">
      <div>
        <b-card>
          <template #header>
            <b-card-img
              src="https://media-exp1.licdn.com/dms/image/D4E03AQFKfOzFSM4Mpg/profile-displayphoto-shrink_400_400/0/1668206363895?e=1674086400&v=beta&t=ayccEam7G1vLp4kYMS4v3mmXZj5uM1aoTj1d7c773N4"
              img-top class="w-25"></b-card-img>
            <h4 class="mb-0 m-1">Leyder Yesid Sanchez Benachi</h4>
            <div class="row d-flex justify-content-center">
              <div class="col-4 w-50 d-flex justify-content-center"><b-form-rating v-model="value1" show-value
                  variant="warning" class="bg-transparent border-0 m-1"></b-form-rating></div>
            </div>
          </template>
          ...
          <b-list-group flush>
            ...
            <b-list-group-item v-b-toggle.accordion-experiencia>Experiencia
              <b-collapse id="accordion-experiencia" accordion="my-accordion" role="tabpanel">
                <b-card-body>
                  <b-card-text>
                    <p>Dos años de experiencia como ayudante en distintas obras de la ciudad de popayan...</p>
                    <!--start card-->
                          ...
                          <b-col md="7">
                            <b-card-body title="Trabajo de construccion">
                              ...
                              <div class="row">
                                <div class="col-4"></div>
                                <div class="row d-flex justify-content-center">
                                  <div class="col-4 w-50 d-flex justify-content-center"><b-form-rating v-model="value1"
                                      show-value variant="warning" class="bg-transparent border-0 m-1"></b-form-rating>
                                  </div>
                                </div>
                                <div class="col-4"></div>
                              </div>
                    ...
                    <div class="d-flex justify-content-center">
                      <b-card no-body class="overflow-hidden" style="max-width: 100%;">
                        <b-row no-gutters>
                          ...
                          <b-col md="5">
                            <b-card-img
                              src="https://technodesing.com/wp-content/uploads/2019/06/Noticia-133479-construccion.jpg"
                              alt="Image" class="rounded-0"></b-card-img>
                          </b-col>
                        </b-row>
                      </b-card>
            ...
            <b-list-group-item href="#">Contratar</b-list-group-item>
            <b-list-group-item href="#"></b-list-group-item>
          </b-list-group>
